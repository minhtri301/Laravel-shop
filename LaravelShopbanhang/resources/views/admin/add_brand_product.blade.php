                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to('/save-brand-product')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="1" class="form-control" name="slug_brand_product" id="exampleInputPassword1" placeholder="Tên danh mục"></textarea>
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="1" class="form-control" name="brand_product_keywords" id="exampleInputPassword1" placeholder="Mô tả danh mục"></textarea>
                        </div>
                        <div class="form-group">
