                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to('/update-brand-product/'.$edit_brand_product->brand_id)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$edit_brand_product->slug_brand_product}}" name="slug_brand_product" class="form-control" id="exampleInputEmail1">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="1" class="form-control" name="brand_product_keywords" id="exampleInputPassword1" placeholder="Mô tả danh mục">{{$edit_brand_product->meta_keywords_brand}}</textarea>
                        </div>
