      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span class="text-ellipsis">
            <?php if($cate_pro->brand_status==0){ ?>
          ...
          <td>
            ...
            <a onclick="return confirm('Bạn có chắc chắn muốn xóa thương hiệu này không?')" href="{{URL::to('/delete-brand-product/'.$cate_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">  
